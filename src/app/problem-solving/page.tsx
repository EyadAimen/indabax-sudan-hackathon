  ...
  return (
    <div>
      ...
      <main className={styles.page}>
        <h1>Track 2: <span className={styles.titleOrdange}>PROBLEM SOLVING</span></h1>
        <p className={styles.pMargin}>Show case your problem-solving skills and innovative ideas to tackle issues in Sudan.</p>
